...
public class Steps extends BrowserUtils {
    ...
    public void the_user_wants_to_see_payment_gate_webside() {
        Driver.getDriver();
        BrowserUtils.setWaitTime();
        driver.get(ConfigurationsReader.getProperties("url"));
        driver.manage().window().maximize();
        System.out.println("The webside is launched");
    ...
    public void the_ser_wants_to_enter_payment_information_as(Map<String,String>dataTable) {
