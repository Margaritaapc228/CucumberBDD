...
public class OrangeHRMSteps extends BrowserUtils {
    ...
    public void the_user_wants_to_go_to_admin_option() {
        admin.setAdminModule();
    }

    @Then("the user wants to go to Nationalities option")
    public void the_user_wants_to_go_to_nationalities_option() {
        staticWait(2);
        admin.setNationalitiesSection();
    }

    @Then("the user wants to go to Add new nationality")
    public void the_user_wants_to_go_to_add_new_nationality() {
    ...
    public void the_user_wants_to_login_orange_hrm_with_excel() throws IOException {
        String filePath = "/Users/margaritaaurora/IdeaProjects/CucumberBDD1/src/test/resources/Book1.xlsx";
